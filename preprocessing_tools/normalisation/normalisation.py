...
def normalise_data(df: pd.DataFrame, reference_population_normalisation_parameters_path:str = '',
                    winsorize:bool = True,
                    variables_to_normalize:list = VARIABLES_TO_NORMALIZE,
    ...
    :param variables_to_normalize: list of variables to normalise (default: all variables in VARIABLES_TO_NORMALIZE)
    :param verbose:
    ...
    if winsorize:
        ...
        for variable in tqdm(variables_to_normalize):
            ...
            winsorizing_parameters_df = pd.concat([
                                            winsorizing_parameters_df,
    ...
    for variable in tqdm(variables_to_normalize):
        ...
        normalisation_parameters_df = pd.concat([
